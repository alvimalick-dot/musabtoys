  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      {data.customer.addresses?.length > 0 && (
        <div className="mt-8 rounded-2xl bg-white p-5 ring-1 ring-black/5 dark:bg-raised dark:ring-white/10">
      ...
      <div className="mt-8">
        ...
        <ul className="mt-4 space-y-3">
          ...
          <li className="rounded-2xl bg-white p-6 text-muted ring-1 ring-black/5 dark:bg-raised dark:ring-white/10">
              No orders yet.{" "}
          ...
          {data.orders.map((o) => (
            <li
              key={o.orderNumber}
              className="flex flex-wrap items-center justify-between gap-3 rounded-2xl bg-white p-4 ring-1 ring-black/5 dark:bg-raised dark:ring-white/10"
            >
              <div>
