    ...
    <div className="mt-8 space-y-8">
      <div className="rounded-3xl bg-white p-6 ring-1 ring-black/5">
        ...
        <form onSubmit={onSave} className="mt-6 grid gap-3 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2 rounded-2xl border-2 border-dashed border-black/10 bg-[#fff8f0] p-4">
      ...
      <div className="rounded-[1.5rem] bg-white p-5 ring-1 ring-black/5">
        ...
        <div className="mt-4 space-y-2">
          {products.map((p) => (
            <div
              key={p._id}
              className="flex flex-col gap-3 rounded-xl bg-[#fff8f0] p-3 sm:flex-row sm:items-center sm:justify-between"
            >
