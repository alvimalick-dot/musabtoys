        ...
        {(
          ...
          <button
            ...
            className={`rounded-full px-4 py-2 text-sm font-bold ${
             tab === id ? "bg-ink text-white dark:bg-white dark:text-black" : "bg-white ring-1 ring-black/5 dark:bg-raised dark:ring-white/10"
            }`}
          >
            {label}
          </button>
...
<div className="mt-6 rounded-2xl bg-[#fde8d4] px-5 py-4 text-sm dark:bg-raised">
            <p className="font-bold text-ink">Photos via Excel (easy way)</p>
            <ol className="mt-2 list-decimal space-y-1 pl-5 text-muted">
              <li>
                Put pictures in the project folder{" "}
               <code className="rounded bg-white px-1.5 py-0.5 text-xs dark:bg-raised dark:text-white">
                  public/images/
                </code>{" "}
                then push to GitHub.
              </li>
          ...
          <label className="mt-8 flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashedborder-black/10 bg-[#fef6ed] px-6 py-14 transition hover:border-coral dark:bg-raised">
          ...
          <div className="mt-6">
            ...
            <div className="mt-2 space-y-2">
              ...
              {recentJobs.map((j) => (
                <div key={String(j._id)} className="flex items-center justify-between gap-2 rounded-md bg-white p-3 ring-1 ring-black/5 dark:bg-raised dark:ring-white/10">
          ...
          <div className="mt-8 overflow-x-auto text-sm">
           ...
           <code className="block rounded-xl bg-ink px-4 py-3 text-xs text-white dark:bg-deep">
                    ...
                    <button
                      ...
                      className={`rounded-full px-3 py-1.5 text-xs font-bold capitalize ${
                        ...
                        ? "bg-ink text-white dark:bg-white dark:text-black"
                          ...
                          : "bg-[#fef6ed] text-ink dark:bg-raised dark:text-white"
                      }`}
                    >
                      {status}
                    </button>
