...
export function CtaBanner() {
  return (
    <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20">
      <motion.div
        className="relative overflow-hidden rounded-[1.75rem] bg-gradient-to-r from-coral via-[#a855f7] to-sky px-5 py-10 text-white sm:rounded-[2.5rem] sm:px-12 sm:py-14"
