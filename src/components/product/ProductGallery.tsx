  ...
  return (
    <div>
      <div className="relative">
        <button
        type="button"
      className="relative aspect-square w-full overflow-hidden rounded-4xl bg-white ring-1 ring-black/5 dark:bg-raised dark:ring-white/10"
      ...
      {list.length > 1 && (
        <>
          <button
            ...
            className="absolute left-3 top-1/2 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full bg-white/90 text-ink shadow transition hover:bg-white dark:bg-raised/90 dark:text-white dark:hover:bg-raised"
          >
          ...
          <button
            ...
            onClick={showNext}
            className="absolute right-3 top-1/2 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full bg-white/90 text-ink shadow transition hover:bg-white dark:bg-raised/90 dark:text-white dark:hover:bg-raised"
          >
        ...
        <div className="fixed inset-0 z-80 flex items-center justify-center bg-ink/80 p-4 pt-[max(1rem,env(safe-area-inset-top))]">
          ...
          <div className="relative z-10 max-h-dvh w-full max-w-4xl">
            <button
              type="button"
              onClick={() => setOpen(false)}
             className="absolute right-2 top-2 z-20 flex h-11 w-11 items-center justify-center rounded-full bg-white shadow-lg dark:bg-raised"
              aria-label="Close"
            >
              <X className="h-4 w-4" />
            </button>
