    ...
    <section id="reviews" className="mx-auto max-w-7xl scroll-mt-24 px-4 py-10 sm:px-6">
      ...
      <div className="mt-6 grid gap-8 lg:grid-cols-[1fr_0.9fr]">
        <ul className="space-y-4">
          {reviews.map((r) => (
          <li key={r._id} className="rounded-2xl bg-white p-4 ring-1 ring-black/5 dark:bg-raised dark:ring-white/10">
        ...
        <form onSubmit={onSubmit} className="h-fit rounded-2xl bg-white p-5 ring-1 ring-black/5 dark:bg-raised dark:ring-white/10">
